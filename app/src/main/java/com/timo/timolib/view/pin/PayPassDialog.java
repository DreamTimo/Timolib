...
public class PayPassDialog {
    ...
    public PayPassDialog(Context context) {
        ...
        this.mPayView = mDialogLayout.findViewById(R.id.pay_View);
        mDialog=new AlertDialog.Builder(mContext,mThemeResId).create();
        mDialog.setCancelable(true);
        mDialog.show();
        mDialog.getWindow().setDimAmount(0f);//设置透明度0.4
    ...
    public void setListener(OnPayPassClickListener listener){
        mPayView.setPayClickListener(listener);
    }
    /**
     * 得到PayPassView控件
     * @return
