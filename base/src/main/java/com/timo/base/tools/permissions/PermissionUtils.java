...
public class PermissionUtils {
    ...
    public static void requestPermissions(
            @NonNull Activity host, @NonNull String rationale, @Size(min = 1) @NonNull String... perms) {
        requestPermissions(
                new PermissionRequest.Builder(host, 00000, perms)
     ...
     */
    public static void requestPermissions(
            @NonNull Fragment host, @NonNull String rationale, @Size(min = 1) @NonNull String... perms) {
        requestPermissions(
                new PermissionRequest.Builder(host, 00000, perms)
                        .setRationale(rationale)
                        .build());
     ...
     */
    public static void onRequestPermissionsResult(PermissiOnGrantedListener listener,
    ...
    private static void notifyAlreadyHasPermissions(@NonNull Object object,
        ...
        onRequestPermissionsResult(null, perms, grantResults);
    }
