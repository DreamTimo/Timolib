...
public class SPUtils {
    ...
    public void save(String key, Object object) {
        ...
        SharedPreferences        sp     = BaseTools.getContext().getSharedPreferences(BASE_SHARE_NAME, Context.MODE_PRIVATE);
    ...
    public void remove(String key) {
        SharedPreferences sp = BaseTools.getContext().getSharedPreferences(BASE_SHARE_NAME,
